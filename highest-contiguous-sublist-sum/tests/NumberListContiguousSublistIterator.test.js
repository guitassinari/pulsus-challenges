...
describe('Number List Sublist Iterator', () => {
  ...
  describe('#next', () => {
    it('returns all contiguous sublists of the original list and returns null after that', () => {
      expect(iterator.next().toArray()).toEqual(originalNumbersArray.slice(0,1))
      ...
      expect(iterator.next().toArray()).toEqual(originalNumbersArray.slice(1,2))
      expect(iterator.next().toArray()).toEqual(originalNumbersArray.slice(1,3))
      expect(iterator.next().toArray()).toEqual(originalNumbersArray.slice(2,3))
